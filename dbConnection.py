...
def data_cases_agesex(cursor: pyodbc.Cursor) -> None:
    data = functions.get_data('https://epistat.sciensano.be/Data/COVID19BE_CASES_AGESEX.json')
    if data is None:
...
def data_mort(cursor: pyodbc.Cursor) -> None:
    data = functions.get_data('https://epistat.sciensano.be/Data/COVID19BE_MORT.json')
    if data is None:
...
def data_municipality(cursor: pyodbc.Cursor) -> None:
    data = functions.get_data('https://epistat.sciensano.be/Data/COVID19BE_CASES_MUNI.json')
    if data is None:
...
def data_vaccins(cursor: pyodbc.Cursor) -> None:
    data = functions.get_data('https://epistat.sciensano.be/Data/COVID19BE_VACC.json')
    if data is None:
